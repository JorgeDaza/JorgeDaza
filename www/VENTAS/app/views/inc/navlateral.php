...
<figure class="full-width" style="height: 300px;"> <!-- Aumentar la altura del contenedor -->
    <div class="navLateral-body-cl" style="height: 100%; display: flex; justify-content: flex-start; align-items: center;"> <!-- Alinear a la izquierda -->
        <?php
        if (is_file("./app/views/fotos/" . $_SESSION['foto'])) {
            $src = APP_URL . 'app/views/fotos/' . $_SESSION['foto'];
        } else {
            $src = APP_URL . 'app/views/fotos/default.png.png';
        }
        ?>
        <img class="is-rounded" style="width: 300px; height: 300px; margin-left: 100px; object-fit: contain;" src="<?php echo $src; ?>"> <!-- Ajustar el tamaño de la imagen y moverla a la derecha -->
    </div>
</figure>
